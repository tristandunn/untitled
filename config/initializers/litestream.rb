...
# Use this hook to configure the litestream-ruby gem. All configuration options
...
Rails.application.configure do
  ...
  # any SFTP server.
  #
  # In this example, we are using Rails encrypted credentials to store the URL
  # to our storage provider bucket.
  # config.litestream.replica_bucket = litestream_credentials&.replica_bucket

  # Replica-specific authentication key.
  #
  # Litestream needs authentication credentials to access your storage provider
  # bucket. In this example, we are using Rails encrypted credentials to store
  # the access key ID.
